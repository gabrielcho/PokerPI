...
public class Jugador {
   ...
   */
  public void llamarCarta(Baraja barajaDeDondeViene, Baraja destino, Carta cartaParaA�adir) {
      destino.addCarta(cartaParaA�adir);
      barajaDeDondeViene.quitarCarta(cartaParaA�adir);
  }
